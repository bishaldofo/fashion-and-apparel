   ...
   return (
      <div>
         <div className="hero" style={{backgroundImage: 'url(https://i.ibb.co/MCVycMx/main-big-banner-1-1-1.webp)'}}>
            ...
            <div className="min-w-screen-2xl md:pr-80 m-auto">
               <div className="hero-content py-8 md:py-10 lg:py-40 text-neutral-content justify-start">
                  <div className="max-w-2xl">
                     ...
                     <button className="btn btn-primary rounded-none bg-[#1F2937] border-0 text-white hover:text-black hover:bg-white">Shop Now!</button>
                  </div>
               </div>
            </div>
         </div>
