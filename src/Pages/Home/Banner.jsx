      ...
      <div>
         <div className="hero" style={{backgroundImage: 'url(https://i.ibb.co/MCVycMx/main-big-banner-1-1-1.webp)'}}>
            ...
            <div className="max-w-screen-2xl m-auto">
               <div className="hero-content w- lg:py-40 text-neutral-content justify-start">
                  <div className="max-w-2xl">
                     <h1 className="mb-5 text-5xl font-bold">Elevate Your Style with Our Latest Collection</h1>
